                            ...
                            <div className="col-xl-4 col-md-6 order-md-1">
                                <div className="match-game-info">
                                    ...
                                    <p className="d-flex flex-wrap justify-content-center  justify-content-md-start">
                                        <span className="match-date"> <Moment format="DD/MM/YYYY">{tournament.start_date}</Moment> </span><span className="match-time"><Moment format="hh:mm:ss">{tournament.start_date}</Moment></span>
                                    </p>
                                </div>
                            </div>
